...
function Mentors() {
    const myMentors = [
        ...
        { id: "4", name: "Eng.Mohammed ElDsoke", image: "../../../dsouke.96415ef3d1dc0a78e0bf.jpg", info: "Lecture at the Faculty of Engineering and Computer Science - Information Systems Department", tech: [oop], channal: "https://www.youtube.com/@DesoukiEgypt" },
        { id: "3", name: "Eng.Salma Mamdouh", image: "../../../salma.png", info: "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", tech: [database], channal: "https://www.youtube.com/@maharatech-itimooca4781" },
    ]
    return (
        <>
            <Card item={myMentors} />
